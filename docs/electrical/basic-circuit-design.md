...
::: info
\*Motors are weird, see the [DC motors document](https://docs.google.com/document/u/0/d/1c0lU_rv7gFpK0vhmaeOoRLiwo3B5bBuv2DtqyB-CWCM/edit) for more if you are interested.
:::
