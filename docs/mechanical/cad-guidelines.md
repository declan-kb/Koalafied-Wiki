...
This document is not final and is open for discussion. As we work each season we should remember to update it.
...
- ‘Variables’ variables studio with the major defining dimensions for the robot.
